...
data='resume'
checkpoint='../checkpoints/resume/Flat_eval_bert-base-chinese_e_27_f_96.82_0.96284.bin'
...
inner_metric = flat_main(dataset=data, head_dim=20,head=8,device=device,ck=checkpoint,output_dir=output_dir )
